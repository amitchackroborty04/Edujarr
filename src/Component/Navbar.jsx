    ...
    <Container>
      <nav className=" py-5 lg:py-7 bg-white relative  ">
        <div className="flex  justify-between items-center">
          ...
          <div className=" w-[40%]  ">
            <ul className={`z-50 flex flex-col lg:flex-row absolute top-0 ${menu ? "right-[-20px]" : "right-[-100%]"} duration-500  lg:static    pl-10 lg:pl-0 pt-10 lg:pt-0  gap-y-5 lg:justify-between bg-[#FFFFFF] lg:bg-transparent h-screen lg:h-auto w-[80%] lg:w-auto cursor-pointer`}>
